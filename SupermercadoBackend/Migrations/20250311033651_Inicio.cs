...
namespace SupermercadoBackend.Migrations
{
    ...
    public partial class Inicio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clientes",
                columns: new[] { "Id", "Apellido", "DNI", "Eliminado", "FechaNacimiento", "LocalidadId", "Nombre", "PuntosFidelizacion", "Telefonos" },
                values: new object[,]
                {
                    { 1, "González", "44064814", false, new DateTime(1985, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Juan", 100, "123456789" },
                    { 2, "Pérez", "44064815", false, new DateTime(1986, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Pedro", 200, "123456789" },
                    { 3, "Gómez", "44064816", false, new DateTime(1987, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "María", 300, "123456789" },
                    { 4, "Rodríguez", "44064817", false, new DateTime(1988, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "José", 400, "123456789" },
                    { 5, "Fernández", "44064818", false, new DateTime(1989, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Ana", 500, "123456789" },
                    { 6, "López", "44064819", false, new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Carlos", 600, "123456789" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2025, 3, 11, 0, 36, 47, 969, DateTimeKind.Local).AddTicks(8869), 0, 21m, 3000m },
                    { 2, 2, false, new DateTime(2025, 3, 11, 0, 36, 47, 969, DateTimeKind.Local).AddTicks(8885), 1, 10m, 5000m },
                    { 3, 1, false, new DateTime(2025, 3, 11, 0, 36, 47, 969, DateTimeKind.Local).AddTicks(8887), 2, 21m, 8000m }
                });
